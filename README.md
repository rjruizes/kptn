...
Kapten is a meta orchestration framework for building R and Python data pipelines with Prefect. It was built after years of experience with Prefect and tuning it from a general-purpose workflow tool to a data pipeline solution. It right-sizes tasks, tests changes, and streamlines development and operation.
