...
def combotest(pipeline_config: PipelineConfig, task_list: TaskListChoices = [], ignore_cache: bool = False):
...
if __name__ == "__main__":
    ...
    combotest(pipeline_config, ignore_cache=args.force)
