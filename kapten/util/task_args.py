...
class TaskArgumentPlan:
    """Details about the arguments Kapten will supply to a task."""
...
def resolve_dependency_key(
    ...
    """Determine the keyword Kapten will use for a dependency's cached data."""
...
def build_task_argument_plan(
    ...
    """Infer the keyword arguments Kapten will provide to a Python task."""
